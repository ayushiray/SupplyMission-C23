...
var packageSprite, packageIMG, package1IMG, package2IMG;
var packageBody, package1Body, package2Body, ground;
...
function setup() {
	...
	package2Sprite=createSprite(width/2, 80, 10,10);
	...
	packageBody2 = Bodies.circle(width/2 , 200 , 15 , {restitution:0.4, isStatic:true});
